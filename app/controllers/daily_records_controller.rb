class DailyRecordsController < ApplicationController
  ...
  private
    ...
    def daily_record_params
      params.require(:daily_record).permit(:report_date, :age, :remedy, :feed_recieved, :feed_actual, :feed_remains, :average_weight, :mortality, :average_temperature, :average_hummidity, :stockman, :notes, :periode_id)
    end
end
