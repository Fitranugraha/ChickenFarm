class DailyReportsController < ApplicationController
  ...
  private
    ...
    def daily_report_params
      params.require(:daily_report).permit(:report_date, :age, :remedy, :feed_recieved, :feed_actual, :feed_remains, :average_weight, :mortality, :average_temperature, :average_hummidity, :stockman, :notes, :periode_id)
    end
end
