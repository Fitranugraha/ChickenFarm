...
class StandardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post standards_url, params: { standard: { age_day: @standard.age_day, avg_bw: @standard.avg_bw, fcr: @standard.fcr, percent_mort: @standard.percent_mort, std_eef: @standard.std_eef } }
    end
  ...
  test "should update standard" do
    patch standard_url(@standard), params: { standard: { age_day: @standard.age_day, avg_bw: @standard.avg_bw, fcr: @standard.fcr, percent_mort: @standard.percent_mort, std_eef: @standard.std_eef } }
